...
export default function SignupPage() {
  ...
  return (
    <div style={{ backgroundColor: colors.bgOuter }} className="min-h-screen flex items-center justify-center p-6">
      
      <div style={{ backgroundColor: colors.bgCard }} className="w-full max-w-5xl flex flex-col md:flex-row rounded-3xl shadow-2xl overflow-hidden border border-white/10">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
          ...
          <h1 style={{ color: colors.white }} className="text-4xl font-extrabold mb-2">Sign Up</h1>
          <p style={{ color: colors.textGray }} className="text-lg mb-6">Create your Hotel Royal account</p>

          {success && (
            <div 
              style={{ backgroundColor: colors.successBg, color: colors.successText }}
              className="mb-6 p-4 border-l-4 border-emerald-500 rounded-r-lg text-sm"
            >
              ✅ {success}
            </div>
          )}
          ...
          <form onSubmit={handleSignup} className="space-y-4" autoComplete="off">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               ...
               <div>
                  <label style={{ color: colors.textGray }} className="text-xs font-bold uppercase tracking-widest mb-1 block">Confirm</label>
                  <input 
                    type="password" 
                    autoComplete="new-password"
                    placeholder="••••••••"
            ...
            <button 
              ...
              className="w-full text-white font-bold py-4 rounded-xl text-xl shadow-lg hover:brightness-110 active:scale-95 transition-all mt-4"
            >
              Create Account
            </button>
          </form>
